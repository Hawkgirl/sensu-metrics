...
services = cloud_obj.services.list_volume_services()
...
msg = ""
if down:
	msg += '{} volume service(s) down.[service name:host] {}'.format(down, down_str)

if disabled:
	msg += '{} volume service(s) disabled.[service name:host] {}'.format(disabled, disabled_str)
