...
services = cloud_obj.services.list_network_services()
...
msg = ""
if down:
	msg += '{} network service(s) down.[service name:host] {}'.format(down, down_str)

if disabled:
	msg += '{} network service(s) disabled.[service name:host] {}'.format(disabled, disabled_str)
